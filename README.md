# 100Hires Portfolio Project — Cursor & AI Setup
...
| Tool | Purpose |
|------|---------|
| [Cursor IDE](https://cursor.com/) | AI-native code editor — primary development environment |
| **Claude Code** (Cursor extension) | AI coding agent for research, drafting, refactoring, and debugging |
| **Codex** (Cursor extension) | OpenAI-powered coding assistant inside the editor |
| **Git** | Version control |
| **GitHub** | Public portfolio and collaboration ([Niranjan-M-T](https://github.com/Niranjan-M-T)) |
...
2. **Installed extensions** in Cursor:
   - Searched Extensions → installed **Claude Code** → signed in
   - Searched Extensions → installed **Codex** → signed in
3. **Created this public GitHub repository** for the portfolio project
4. **Opened the repository in Cursor** and used AI tools to structure and write this documentation
5. **Committed and pushed** `README.md` to GitHub
6. **Mapped my existing projects** to the 100Hires job description (see below)
...
I was already familiar with Cursor, extensions, and GitHub. Below are the friction points I typically hit — and how I resolve them without waiting for help.
...
## What I Would Do at 100Hires (Day One Mindset)

1. **Research channels** — find what works for ATS/hiring SaaS audiences, document playbooks  
2. **Produce content** — blogs, comparison pages, landing pages, email sequences — draft with AI, polish with human judgment  
3. **Measure everything** — track CTR, conversions, and content performance; cut underperformers quickly  
4. **Ship with autonomy** — high standards, direct feedback, no meetings-about-meetings  
...
*Submitted as part of the 100Hires portfolio project — demonstrating self-reliance, AI fluency, and growth marketing execution.*
